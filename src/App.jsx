  ...
  return (
    <div style={{ fontFamily: "'DM Mono', monospace" }}>
      ...
      <div style={{ display: "flex", gap: "12px", marginBottom: "20px", flexWrap: "wrap", alignItems: "center" }}>
        <div style={{ display: "flex", gap: 0, border: "1px solid #2A3D5A", borderRadius: "6px", overflow: "hidden" }}>
          {["status", "owner"].map(m => (
            <button key={m} onClick={() => setPivotMode(m)} style={{
              padding: "6px 16px", background: pivotMode === m ? "#0F2340" : "transparent",
              color: pivotMode === m ? "#E8D5B0" : "#7A9BB5", border: "none", cursor: "pointer",
        ...
        <span style={{ color: "#4A7FA5", fontSize: "11px", fontFamily: "inherit" }}>
